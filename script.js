...
const mahmudi = new Player('mahmudi', 7, 10, 7, 8, 8);
const rasool = new Player('rasool', 6, 4, 7, 7, 7);
...
const farahani = new Player('farahani', 0, 6, 6, 6, 6);
const mamul = new Player('mamul', 6, 6, 6, 6, 6);
...
const ashkan = new Player('ashkan', 8, 7, 7, 8, 7);
